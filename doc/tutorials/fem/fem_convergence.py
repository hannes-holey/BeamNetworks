...
ax[0, 1].set_ylabel(r'$|\Delta u|$');    ax[0, 1].set_yscale('log')
ax[1, 1].set_ylabel(r'$|\Delta \theta|$'); ax[1, 1].set_yscale('log')
ax[1, 1].set_xlabel('p')
ax[0, 2].set_title('Exact integration ($p+1$)')
ax[0, 2].set_ylabel(r'$|\Delta u|$');    ax[0, 2].set_yscale('log')
ax[1, 2].set_ylabel(r'$|\Delta \theta|$'); ax[1, 2].set_yscale('log')
ax[1, 2].set_xlabel('p')
...
ax[0, 1].set_ylabel(r'$|\Delta u|$');    ax[0, 1].set_yscale('log')
ax[1, 1].set_ylabel(r'$|\Delta \theta|$'); ax[1, 1].set_yscale('log')
ax[1, 1].set_xlabel('$n_\mathrm{sub}$')
ax[0, 2].set_title('Exact integration ($p+1$)')
ax[0, 2].set_ylabel(r'$|\Delta u|$');    ax[0, 2].set_yscale('log')
ax[1, 2].set_ylabel(r'$|\Delta \theta|$'); ax[1, 2].set_yscale('log')
ax[1, 2].set_xlabel('$n_\mathrm{sub}$')
